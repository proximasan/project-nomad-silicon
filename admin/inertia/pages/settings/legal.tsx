      ...
      <div className="xl:pl-72 w-full">
        <main className="px-12 py-6 max-w-4xl">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside space-y-2 text-text-primary">
              <li><strong>Installation Directory:</strong> ~/project-nomad (macOS) or /opt/project-nomad (Linux)</li>
              <li><strong>Downloaded Content:</strong> ~/project-nomad/storage (macOS) or /opt/project-nomad/storage (Linux)</li>
